@extends('layouts.wording')
@section('content')
<div class="container verbose">
    <h4><strong>Terms and Conditions</strong></h4>

    <p>Welcome to GoodVibezzz!</p>

    <p>These terms and conditions outline the rules and regulations for the use of GoodVibezzz's Website, located at
        https://GoodVibezzz.fr.</p>

    <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use GoodVibezzz if
        you
    ...
    <p>We do not use cookies … Not yet </p>

    <h5><strong>License</strong></h5>

    <p>Unless otherwise stated, GoodVibezzz and/or its licensors own the intellectual property rights for all material
        on
        GoodVibezzz. All intellectual property rights are reserved. You may access this from GoodVibezzz for your own
        personal use subjected to restrictions set in these terms and conditions.</p>

    <p>You must not:</p>
    <ul>
        <li>Republish material from GoodVibezzz</li>
        <li>Sell, rent or sub-license material from GoodVibezzz</li>
        <li>Reproduce, duplicate or copy material from GoodVibezzz</li>
        <li>Redistribute content from GoodVibezzz</li>
    </ul>
    ...
    <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
        areas
        of the website. GoodVibezzz does not filter, edit, publish or review Comments prior to their presence on the
        website. Comments do not reflect the views and opinions of GoodVibezzz,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and opinions. To the extent permitted by
        applicable laws, GoodVibezzz shall not be liable for the Comments or for any liability, damages or expenses
        caused
        and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.
    </p>

    <p>GoodVibezzz reserves the right to monitor all Comments and to remove any Comments which can be considered
    ...
    <p>You hereby grant GoodVibezzz a non-exclusive license to use, reproduce, edit and authorize others to use,
        reproduce
    ...
    <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
        ...
        records
        with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of GoodVibezzz; and
        (d)
    ...
    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you
        must inform us by sending an e-mail to GoodVibezzz. Please include your name, your organization name, contact
    ...
    <p>No use of GoodVibezzz's logo or other artwork will be allowed for linking absent a trademark license agreement.
    </p>
