...
<div class="about-content paddingtop p-4 d-flex flex-column">
    ...
    <p>
        ...
        Nous utilisons une technologie d'IA pour maximiser la probabilité que tes questions trouvent les utilisateurs
        les plus susceptibles de te répondre. Tes questions restent totalement anonymes. Tes messages et discussions
        sont éffacés toutes les 24H. Dans la section paramètres, tu peux gérer tes préférences de notifications
        mails<br><br>

        On te fait confiance pour rester bienveillant avec les autres utilsateurs 😉  <br>

        Pour tout problème survenu sur le site, écris-nous à<br>
        hello@weigu-app.com
</div>
