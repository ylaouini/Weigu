        ...
        <div class="form sign-in">
            <div class="signupform">
                <div class="d-flex flex-column topst">
                    ...
                    <h5 class="rejoindre">Rejoindre <span class="pagelogo">Weigu</span></h5>
...
{{--                        </div>--}}
                        <div class="group-radio">
                            ...
                            <div class="radio_group">
                                <input class="myradio" type="radio" name="gender" title="Femme" value="1" checked=""
                            ...
                            <div class="radio_group">
                                <input class="myradio" type="radio" name="gender" title="Homme" value="0" required
                        ...
                        <div class="dategroup">
                            ...
                            <div class="select-date">
                                ...
                                <div class="date-div">
                                    <select class="form-control" id="select-year" name='birth_year'
                                            placeholder="Année"></select>
                                </div>
                                <div class="date-div">
                                    <select class="form-control" id="select-month" name='birth_month'
                                            placeholder="Mois">
                                ...
                                <div class="date-div">
                                    <select class="form-control" id="select-day" name='birth_day'
                                            placeholder="Jour"></select>
                                </div>
                            </div>
                        </div>
...
{{--                        </div>--}}
                        <div class="description">
                            Et si on faisait les choses simplement ?<br>
                            Initie des discussions <span>en posant des questions</span>.
                            Sur Weigu, tu découveres différents points de vue sur la vie.
                        </div>
...
{{--                    </div>--}}
    ...
    <script>
        ...
        $('#registerForm').submit(function(e){
            ...
            userData.push({'name': 'birth_date', 'value': userData[4].value + '/' + userData[5].value + '/' + userData[6].value});
