...
<div class="container verbose">
    <h3>Privacy Policy for Weigu</h3>

    <p>At GoodVibezzz, accessible from https://GoodVibezzz.fr, one of our main priorities is the privacy of our
        visitors.
        This Privacy Policy document contains types of information that is collected and recorded by GoodVibezzz and how
        we
        use it.</p>
    ...
    <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards
        to
        the information that they shared and/or collect in GoodVibezzz. This policy is not applicable to any information
        ...
        <ul>
            ...
            <li>Communicate with you, either directly or through one of our partners, including for customer service, to
                provide
                you with updates and other information relating to the webste, and for marketing and promotional
                purposes
            </li>
        ...
        <p>GoodVibezzz follows a standard procedure of using log files. These files log visitors when they visit
            websites.
            All
        ...
        <P>You may consult this list to find the Privacy Policy for each of the advertising partners of GoodVibezzz.</p>

        <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
            used in
            their respective advertisements and links that appear on GoodVibezzz, which are sent directly to users'
            browser.
        ...
        <p>Note that GoodVibezzz has no access to or control over these cookies that are used by third-party
            advertisers.
        </p>

        <h4>Third Party Privacy Policies</h4>

        <p>GoodVibezzz's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
            consult
        ...
        <p>GoodVibezzz does not knowingly collect any Personal Identifiable Information from children under the age of
            13.
            If
